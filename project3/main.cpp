...
void simulator(int iterations, int duration, int particles, std::string axis);

int main(int argc, char const *argv[]) {

    simulator(100, 100, 1, "z");
    simulator(100, 100, 2, "xy");
...
void simulator(int iterations, int duration, int particles, std::string axis) {
    ...
    std::string filename = "Results/i_"+std::to_string(iterations)+"_d_"+std::to_string(duration)+"_p_"+std::to_string(particles)+"_axis_"+axis+".txt";
    std::ofstream ofile;
    ofile.open(filename);
